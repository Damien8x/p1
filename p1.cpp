...
// Version: 1.0
//
// Desctription: Application driver is designed to test all public funtions provided by the EncryptWord class, including all data types and values outside or permitted range.
...
// The functions of the EncryptWord class are dependent on a logical order, encryption firtst, game sencond, stats and object reset last, in order to maintain any integrety to
...
void testCheckShiftBoundries(EncryptWord& ew) {
	...
	cout << ew.encrypt("this is to test special characters 123 123 !@#$%^&*( ") << endl << endl;
